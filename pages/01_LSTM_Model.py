...
path = "A:\\Crypto-price-prediction-main\\convertcsv.csv"
csv = pd.read_csv(path,delimiter=',')
symbol = csv['symbol'].tolist()
print(csv.columns)

# creating sidebar
ticker_input = st.selectbox('Enter or Choose Crypto Coin', symbol,index=symbol.index('ETH-USD'))
...
df = yf.download(ticker_input, a, end=b)
